...
- <a id="f-honor_rank_points"></a>**`honor_rank_points`** - Current rank points from the last honor day.
- <a id="f-honor_highest_rank"></a>**`honor_highest_rank`** - Highest rank ever achieved.
- <a id="f-honor_standing"></a>**`honor_standing`** - Position within the rank for this honor week.
- <a id="f-honor_last_week_hk"></a>**`honor_last_week_hk`** - Yesterday/last-week HK & CP bookkeeping for the honor day tick.
- <a id="f-honor_last_week_cp"></a>**`honor_last_week_cp`** - Yesterday/last-week HK & CP bookkeeping for the honor day tick.
- <a id="f-honor_stored_hk"></a>**`honor_stored_hk`** - Lifetime total honorable kills accumulated across honor-week ticks.
- <a id="f-honor_stored_dk"></a>**`honor_stored_dk`** - Lifetime total dishonorable kills accumulated across honor-week ticks.
